...
- **A · AI-use disclosure** — name every tool and where used (required). e.g., *[Claude/ChatGPT/Gemini]* for analysis, structuring exhibits, drafting copy, red-teaming; *Python* for the three-path model; **Smart-Prep** — a Python prototype we built (Holt-Winters forecast + newsvendor optimizer, **backtested**, **benchmarked vs LightGBM**) plus an Excel demo; *[Canva/Gamma/Claude]* for design. *Honesty note: only the spoilage use is built today; reorder/utang/baskets are designed extensions of the same engine, not yet running.*
